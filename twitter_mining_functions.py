...
double_meaning_words = ['trojan horse','mitm','dos', 'worm', 'trojan', 'dns', 'hacker', 'xss', 'mirai', 'rat',  'spammer', 'exploit', 'cybersecur', 'petya', 'apt', 'scammer', 'exodus', 'backdoor', 'trojan', 'infosec', 'locki']
