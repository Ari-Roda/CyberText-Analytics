    ...
    html.Div([
      ...
      html.Div(dcc.DatePickerRange(
        ...
        html.Div(children=[dcc.Markdown(
                   " Copyright 2020 [CTA](https://github.com/ishikawa-rei)  All Rights Reserved.")], style={'marginLeft': 5, 'marginRight': 5, 'marginTop': 0, 'marginBottom': 10,
        ...
        html.Div(children=[dcc.Markdown(
                   " Copyright 2020 [CTA](https://github.com/ishikawa-rei)  All Rights Reserved.")], style={'marginLeft': 5, 'marginRight': 5, 'marginTop': 10, 'marginBottom': 10,
               'backgroundColor':'#F7FBFE',
               'border': 'thin lightgrey dashed', 'padding': '6px 0px 0px 8px'}),
